...
package starling.display
{
    ...
    public class Image extends Quad
    {
		...
		public function setTexCoordsForTurn(vertexID:int, coords:Point):void
		{
			mVertexData.setTexCoords(vertexID, coords.x, coords.y);
		}
		
		public function refreshTexCoords():void
		{
			onVertexDataChanged();
		}
		
		public function setPositionTo(vertexID:int, u:Number, v:Number):void
		{
			mVertexData.setPosition(vertexID,u,v);
		}
